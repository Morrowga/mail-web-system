                            ...
                            <VForm @submit.prevent="formSubmit">
                                <VCard class="ma-4">
                                    <VCardText>
                                        ...
                                        <div>
                                            <VBtn color="customBtnColor" prepend-icon="mdi-content-save-all-outline"  type="submit" class="text-white text-capitalize">{{ props?.template ? $t('buttons.update') : $t('buttons.registration') }}</VBtn>
                                        </div>
                                    </VCardText>
                                </VCard>
                            </VForm>
