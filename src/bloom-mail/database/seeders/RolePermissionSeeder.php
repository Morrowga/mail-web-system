...
class RolePermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissionArrays = [
            ...
            [
                "name" => "noti_createdit",
                "display" => "Notification Creation / Edit",
                "description" => "Notification Creation and Modification"
            ],
            [
                "name" => "noti_read",
            ...
            [
                "name" => "noti_delete",
                "display" => "Notification Deletion",
                "description" => "Notification Deletion "
            ],
            [
                "name" => "shop_createdit",
                "display" => "Shop Creation / Edit",
                "description" => "Shop Creation and Modification"
            ],
            [
                "name" => "shop_read",
                "display" => "Shop Read",
